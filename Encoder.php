...
class Encoder
{
    ...
    /**
     * Generates all values needed for the encoded Google Maps [\bariew\google\maps\overlays\Polyline].
     *
     * @param array $points Multidimensional input array of [\bariew\google\maps\Point] elements
     *
